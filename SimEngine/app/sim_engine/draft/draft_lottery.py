...
# ==================================================
# ODDS GENERATION (NHL-style for 16 teams, else linear)
# ==================================================

# NHL lottery weights for picks 1-16 (worst to best): 18.5%, 13.5%, 11.5%, 9.5%, 8.5%, 7.5%, 6.5%, 6.0%, 5.0%, 3.5%, 3.0%, 2.5%, 2.0%, 1.5%, 1.0%, 0.5%
NHL_LOTTERY_WEIGHTS_16: List[float] = [
    0.185, 0.135, 0.115, 0.095, 0.085, 0.075, 0.065, 0.060,
    0.050, 0.035, 0.030, 0.025, 0.020, 0.015, 0.010, 0.005,
]
