...
# --------------------------------------------------
        ...
        league_morale_pressure = max(0.0, float(league_nudges["morale_volatility_mod"]) - 1.0)
        ...
        ctx = BehaviorContext(
            ...
            ice_time_satisfaction=clamp(
                0.35 + float(season_stats.get("performance_score", 0.50)) * 0.65,
                0.20,
                0.95,
            ),
