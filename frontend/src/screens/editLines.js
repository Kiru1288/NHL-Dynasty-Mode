...
function EditLinesStyles() {
  return <style>{`
.linebuilder-root{--bg:#06111d;--panel:#0a1928;--panel2:#0d2133;--line:rgba(67,206,230,.24);--line2:rgba(67,206,230,.55);--cyan:#4bd9ee;--gold:#e4bd62;--green:#54d49b;--red:#ef7272;--text:#edf7fb;--muted:#8da9b7;--muted2:#678493;width:100%;height:100vh;height:100dvh;overflow:hidden;color:var(--text);background:linear-gradient(145deg,#06111d,#081522 55%,#07131f);font-family:Inter,system-ui,sans-serif;display:grid;grid-template-columns:88px minmax(0,1fr)}
...
.linebuilder-root .lb-sidebar{height:100%;padding:10px 8px;border-right:1px solid var(--line);background:rgba(4,14,24,.9);display:flex;flex-direction:column;gap:10px;overflow:hidden}.linebuilder-root .lb-team-mark{height:46px;flex:0 0 46px;border:1px solid var(--line2);border-radius:9px;display:grid;place-items:center;color:var(--cyan);font-size:12px;font-weight:900;letter-spacing:.09em;background:rgba(75,217,238,.1)}.linebuilder-root .lb-nav{flex:1;min-height:0;display:grid;grid-template-rows:repeat(5,minmax(0,1fr));gap:8px}.linebuilder-root .lb-nav-btn{width:100%;min-height:0;height:100%;padding:6px 4px;border:1px solid transparent;border-radius:9px;color:var(--muted);background:transparent;cursor:pointer;display:grid;place-items:center;align-content:center;gap:3px}.linebuilder-root .lb-nav-btn:hover,.linebuilder-root .lb-nav-btn.active{color:var(--cyan);border-color:var(--line2);background:rgba(75,217,238,.1)}.linebuilder-root .lb-nav-label{font-size:9px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.linebuilder-root .lb-glyph{width:22px;height:22px;display:inline-grid;place-items:center;border:1px solid currentColor;border-radius:6px;font-size:9px;font-weight:900;line-height:1}
.linebuilder-root .lb-shell{min-width:0;min-height:0;height:100%;padding:10px;display:grid;grid-template-rows:62px 38px minmax(0,1fr);gap:8px;overflow:hidden}.linebuilder-root .lb-header{height:62px;border:1px solid var(--line);border-radius:10px;background:linear-gradient(180deg,rgba(13,33,51,.96),rgba(8,23,36,.96));box-shadow:0 8px 20px rgba(0,0,0,.16);display:flex;align-items:center;justify-content:space-between;gap:10px;padding:8px 10px;position:relative;z-index:20}.linebuilder-root .lb-title-group{min-width:0;display:flex;align-items:center;gap:10px}.linebuilder-root .lb-logo{width:42px;height:42px;flex:0 0 42px;border:1px solid var(--line2);border-radius:8px;background:rgba(4,14,24,.72);display:grid;place-items:center;overflow:hidden;color:var(--cyan);font-size:11px;font-weight:900}.linebuilder-root .lb-logo img{width:34px;height:34px;object-fit:contain}.linebuilder-root .lb-title-copy{min-width:0;display:flex;align-items:baseline;gap:9px}.linebuilder-root .lb-title{margin:0;font-size:clamp(20px,2vw,28px);line-height:1;letter-spacing:-.035em;font-weight:900;white-space:nowrap}.linebuilder-root .lb-roster-count{color:var(--muted);font-size:11px;font-weight:800;white-space:nowrap}.linebuilder-root .lb-actions{display:flex;align-items:center;justify-content:flex-end;gap:6px}.linebuilder-root .lb-btn,.linebuilder-root .lb-icon{min-height:38px;border:1px solid var(--line);border-radius:8px;color:var(--text);background:rgba(255,255,255,.025);cursor:pointer;font-size:11px;font-weight:850}.linebuilder-root .lb-btn{padding:0 12px;display:inline-flex;align-items:center;justify-content:center;gap:6px;white-space:nowrap}.linebuilder-root .lb-icon{width:38px;padding:0;display:inline-grid;place-items:center}.linebuilder-root .lb-btn:hover:not(:disabled),.linebuilder-root .lb-icon:hover:not(:disabled){border-color:var(--line2);background:rgba(75,217,238,.1)}.linebuilder-root .lb-btn:disabled,.linebuilder-root .lb-icon:disabled{opacity:.38;cursor:not-allowed}.linebuilder-root .lb-btn.primary{color:#18150d;border-color:rgba(255,226,155,.74);background:linear-gradient(180deg,#eccb79,#d5a944);box-shadow:0 5px 14px rgba(228,189,98,.15)}.linebuilder-root .lb-btn.subtle{color:var(--muted);border-color:rgba(67,206,230,.14);background:transparent;font-weight:750}.linebuilder-root .lb-btn.subtle:hover:not(:disabled){color:var(--text);border-color:var(--line);background:rgba(255,255,255,.04)}.linebuilder-root .lb-btn.subtle.danger{color:#c98989;border-color:rgba(239,114,114,.22)}.linebuilder-root .lb-btn.subtle.danger:hover:not(:disabled){color:#ffd5d5;border-color:rgba(239,114,114,.5);background:rgba(239,114,114,.1)}.linebuilder-root .lb-btn.danger{color:#ffd5d5;border-color:rgba(239,114,114,.45);background:rgba(239,114,114,.08)}.linebuilder-root .lb-save-error{color:var(--red);font-size:10px;font-weight:800}
.linebuilder-root .lb-status{height:38px;border:1px solid var(--line);border-radius:9px;background:rgba(8,25,40,.8);padding:4px 6px;display:flex;align-items:center;gap:5px;overflow:hidden}.linebuilder-root .lb-pill{height:28px;padding:0 9px;border-right:1px solid var(--line);display:flex;align-items:center;gap:6px;white-space:nowrap}.linebuilder-root .lb-pill:last-child{border-right:0}.linebuilder-root .lb-pill-label{color:var(--muted2);font-size:9px;font-weight:850;letter-spacing:.06em;text-transform:uppercase}.linebuilder-root .lb-pill-value{font-size:12px;font-weight:900;font-variant-numeric:tabular-nums}
.linebuilder-root .lb-workspace{min-width:0;min-height:0;height:100%;display:grid;grid-template-columns:270px minmax(0,1fr) 300px;gap:10px;overflow:hidden}.linebuilder-root .lb-region{min-width:0;min-height:0;height:100%;border:1px solid var(--line);border-radius:10px;background:linear-gradient(180deg,rgba(11,30,47,.97),rgba(7,21,33,.97));box-shadow:0 8px 20px rgba(0,0,0,.14);overflow:hidden;display:grid;grid-template-rows:44px minmax(0,1fr)}.linebuilder-root .lb-region-head{height:44px;padding:0 10px;border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;gap:8px;background:rgba(255,255,255,.016)}.linebuilder-root .lb-region-title{margin:0;font-size:11px;font-weight:900;letter-spacing:.09em;text-transform:uppercase}.linebuilder-root .lb-region-note{color:var(--muted);font-size:10px;font-weight:800;white-space:nowrap}
.linebuilder-root .lb-pool{min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);gap:6px;padding:8px;overflow:hidden}.linebuilder-root .lb-pool-toolbar{display:block}.linebuilder-root .lb-search-wrap{position:relative}.linebuilder-root .lb-search{width:100%;height:32px;padding:0 28px 0 9px;border:1px solid var(--line);border-radius:7px;color:var(--text);background:rgba(3,14,24,.72);outline:none;font-size:11px}.linebuilder-root .lb-search::placeholder{color:var(--muted2)}.linebuilder-root .lb-clear{position:absolute;top:2px;right:2px;width:28px;height:28px;border:0;border-radius:6px;color:var(--muted);background:transparent;cursor:pointer}.linebuilder-root .lb-clear:hover{color:var(--cyan);background:rgba(75,217,238,.1)}.linebuilder-root .lb-player-list{min-height:0;height:100%;display:flex;flex-direction:column;gap:3px;overflow-x:hidden;overflow-y:auto;padding-right:4px;scrollbar-width:thin;scrollbar-color:rgba(67,206,230,.45) rgba(3,14,24,.72)}.linebuilder-root .lb-player-list::-webkit-scrollbar{width:8px}.linebuilder-root .lb-player-list::-webkit-scrollbar-track{background:rgba(3,14,24,.72);border:1px solid rgba(67,206,230,.18);border-radius:8px}.linebuilder-root .lb-player-list::-webkit-scrollbar-thumb{background:linear-gradient(180deg,rgba(75,217,238,.55),rgba(67,206,230,.28));border:1px solid rgba(67,206,230,.35);border-radius:8px}.linebuilder-root .lb-player-list::-webkit-scrollbar-thumb:hover{background:rgba(75,217,238,.7)}.linebuilder-root .lb-player{flex:0 0 auto;min-height:42px;height:42px;padding:3px 7px 3px 4px;border:1px solid rgba(67,206,230,.16);border-left:3px solid transparent;border-radius:6px;background:rgba(255,255,255,.028);display:grid;grid-template-columns:34px minmax(0,1fr) 34px;gap:7px;align-items:center;cursor:grab}.linebuilder-root .lb-player:nth-child(even){background:rgba(255,255,255,.012)}.linebuilder-root .lb-player:hover{border-color:var(--line2);background:rgba(75,217,238,.08)}.linebuilder-root .lb-player.selected{border-color:var(--cyan);border-left-color:var(--cyan);background:rgba(12,48,64,.95);box-shadow:inset 0 0 0 1px rgba(75,217,238,.18)}.linebuilder-root .lb-player.assigned{border-left-color:rgba(141,169,183,.7);background:rgba(0,0,0,.32)}.linebuilder-root .lb-player.assigned .lb-player-name{color:#b7c9d3}.linebuilder-root .lb-player.disabled{cursor:not-allowed;opacity:.4}.linebuilder-root .lb-player.locked{border-color:rgba(228,189,98,.42)}.linebuilder-root .lb-player .player-headshot{width:32px!important;height:32px!important}.linebuilder-root .lb-player-copy{min-width:0}.linebuilder-root .lb-player-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:900;letter-spacing:-.01em;line-height:1.1}.linebuilder-root .lb-player-meta{margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted2);font-size:8px;font-weight:600}.linebuilder-root .lb-player-side{display:grid;justify-items:end;align-content:center;gap:3px}.linebuilder-root .lb-player-ovr{min-width:28px;width:100%;text-align:right;color:var(--cyan);font-size:12px;font-weight:900;font-variant-numeric:tabular-nums;line-height:1}.linebuilder-root .lb-dot{display:inline-block;width:6px;height:6px;border-radius:50%;background:var(--green)}.linebuilder-root .lb-dot.warn{background:var(--gold)}.linebuilder-root .lb-dot.bad{background:var(--red)}
.linebuilder-root .lb-board-region{grid-template-rows:36px minmax(0,1fr)}.linebuilder-root .lb-modebar{height:36px;padding:0 8px;border-bottom:1px solid var(--line);display:flex;align-items:stretch;justify-content:flex-start;gap:0;background:rgba(0,0,0,.22)}.linebuilder-root .lb-mode{min-width:0;flex:0 0 auto;padding:0 14px;border:0;border-bottom:3px solid transparent;border-radius:0;color:var(--muted);background:transparent;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;white-space:nowrap}.linebuilder-root .lb-mode:hover{color:var(--text)}.linebuilder-root .lb-mode.active{color:var(--text);border-bottom-color:var(--cyan);box-shadow:inset 0 -3px 0 var(--cyan)}.linebuilder-root .lb-mobile-tools{display:none;margin-left:auto;gap:4px}.linebuilder-root .lb-board{min-width:0;min-height:0;height:100%;padding:0;display:grid;gap:0;overflow:hidden;align-content:stretch}.linebuilder-root .lb-board.forwards{grid-template-rows:26px repeat(4,minmax(0,1fr))}.linebuilder-root .lb-board.defense{grid-template-rows:26px repeat(3,minmax(0,1fr))}.linebuilder-root .lb-board.goalies{grid-template-rows:26px minmax(0,1fr)}.linebuilder-root .lb-board.special.pp{grid-template-rows:26px repeat(2,minmax(0,1fr))}.linebuilder-root .lb-board.special.pk{grid-template-rows:26px repeat(3,minmax(0,1fr))}.linebuilder-root .lb-col-headers{display:grid;grid-template-columns:56px minmax(0,1fr) 72px;align-items:center;padding:0 8px;margin:0;border-bottom:1px solid rgba(67,206,230,.28);height:26px;background:rgba(0,0,0,.2)}.linebuilder-root .lb-col-headers-spacer{min-height:1px}.linebuilder-root .lb-col-headers-slots{display:grid;gap:6px;padding:0 4px}.linebuilder-root .lb-col-headers-slots.forwards{grid-template-columns:repeat(3,minmax(0,1fr))}.linebuilder-root .lb-col-headers-slots.defense,.linebuilder-root .lb-col-headers-slots.goalies{grid-template-columns:repeat(2,minmax(0,1fr))}.linebuilder-root .lb-col-headers-slots.goalies.third{grid-template-columns:repeat(3,minmax(0,1fr))}.linebuilder-root .lb-col-headers-slots.pp{grid-template-columns:repeat(5,minmax(0,1fr))}.linebuilder-root .lb-col-headers-slots.pk{grid-template-columns:repeat(4,minmax(0,1fr))}.linebuilder-root .lb-col-header{text-align:center;color:var(--muted);font-size:10px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.linebuilder-root .lb-col-headers-chem{text-align:center;color:var(--muted);font-size:10px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}
.linebuilder-root .lb-unit{min-width:0;min-height:0;height:100%;margin:0;border:0;border-bottom:3px solid rgba(67,206,230,.34);border-radius:0;background:rgba(255,255,255,.012);display:grid;grid-template-columns:56px minmax(0,1fr) 72px;align-items:stretch;position:relative;overflow:visible}.linebuilder-root .lb-unit.stripe{background:rgba(255,255,255,.045)}.linebuilder-root .lb-unit.selected{background:rgba(75,217,238,.1);box-shadow:inset 4px 0 0 var(--cyan)}.linebuilder-root .lb-unit.primary{box-shadow:inset 4px 0 0 var(--gold)}.linebuilder-root .lb-unit.primary.selected{box-shadow:inset 4px 0 0 var(--cyan)}.linebuilder-root .lb-unit-label{padding:6px 4px;border-right:1px solid rgba(67,206,230,.18);display:flex;flex-direction:column;justify-content:center;align-items:center;gap:2px;align-self:stretch;background:rgba(0,0,0,.12)}.linebuilder-root .lb-unit-kicker{color:var(--muted2);font-size:8px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.linebuilder-root .lb-unit-name{font-size:18px;font-weight:950;letter-spacing:-.02em;line-height:1}.linebuilder-root .lb-unit-locks{color:var(--gold);font-size:8px;font-weight:850}.linebuilder-root .lb-slots{min-width:0;min-height:0;height:100%;padding:6px 8px;display:grid;gap:6px;align-items:stretch}.linebuilder-root .lb-slots.forwards{grid-template-columns:repeat(3,minmax(0,1fr))}.linebuilder-root .lb-slots.defense,.linebuilder-root .lb-slots.goalies{grid-template-columns:repeat(2,minmax(0,1fr))}.linebuilder-root .lb-slots.goalies.third{grid-template-columns:repeat(3,minmax(0,1fr))}.linebuilder-root .lb-slots.pp{grid-template-columns:repeat(5,minmax(0,1fr))}.linebuilder-root .lb-slots.pk{grid-template-columns:repeat(4,minmax(0,1fr))}
.linebuilder-root .lb-slot{min-width:0;min-height:0;height:100%;padding:6px 8px;border:1px solid rgba(67,206,230,.22);border-radius:8px;background:rgba(3,15,25,.62);display:grid;grid-template-columns:36px minmax(0,1fr) 34px;gap:8px;align-items:center;cursor:pointer;position:relative;overflow:hidden}.linebuilder-root .lb-slot.occupied{border-style:solid;border-color:rgba(67,206,230,.28);background:rgba(5,20,32,.82)}.linebuilder-root .lb-slot.selected{border-color:var(--cyan);background:rgba(8,40,56,.98);box-shadow:inset 4px 0 0 var(--cyan),inset 0 0 0 1px rgba(75,217,238,.28);padding-right:48px}.linebuilder-root .lb-slot.valid{border-color:var(--cyan);background:rgba(75,217,238,.1)}.linebuilder-root .lb-slot.swap{border-color:var(--gold);background:rgba(228,189,98,.13)}.linebuilder-root .lb-slot.invalid{border-color:var(--red);background:rgba(239,114,114,.08)}.linebuilder-root .lb-slot.locked{border-color:rgba(228,189,98,.48)}.linebuilder-root .lb-slot.starter{border-left:3px solid var(--gold)}.linebuilder-root .lb-slot.backup{border-left:3px solid var(--cyan)}.linebuilder-root .lb-slot-shot{display:grid;place-items:center}.linebuilder-root .lb-slot .player-headshot{width:34px!important;height:34px!important}.linebuilder-root .lb-slot-pos{width:34px;height:34px;border:1px solid var(--line);border-radius:7px;display:grid;place-items:center;color:var(--cyan);font-size:9px;font-weight:950}.linebuilder-root .lb-slot-copy{min-width:0;display:flex;flex-direction:column;justify-content:center;gap:3px}.linebuilder-root .lb-slot-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:900;letter-spacing:-.015em;line-height:1.05}.linebuilder-root .lb-slot-meta{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted2);font-size:9px;font-weight:600}.linebuilder-root .lb-slot-empty{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:11px;font-weight:800}.linebuilder-root .lb-slot-side{display:grid;justify-items:end;align-content:center;gap:2px}.linebuilder-root .lb-slot-ovr{text-align:right;color:var(--cyan);font-size:13px;font-weight:900;font-variant-numeric:tabular-nums;line-height:1}.linebuilder-root .lb-drop{color:var(--red);font-size:8px;font-weight:900}.linebuilder-root .lb-markers{display:flex;justify-content:flex-end;gap:3px}.linebuilder-root .lb-marker{width:14px;height:14px;border:1px solid currentColor;border-radius:4px;display:grid;place-items:center;color:var(--muted);font-size:7px;font-weight:900}.linebuilder-root .lb-marker.lock{color:var(--gold)}.linebuilder-root .lb-marker.bad{color:var(--red)}.linebuilder-root .lb-slot-actions{position:absolute;top:50%;right:6px;transform:translateY(-50%);z-index:4;display:flex;gap:4px}.linebuilder-root .lb-mini{width:22px;height:22px;border:1px solid var(--line);border-radius:6px;color:var(--muted);background:#071725;cursor:pointer;display:grid;place-items:center;font-size:9px;font-weight:900}.linebuilder-root .lb-mini:hover{color:var(--cyan);border-color:var(--line2)}.linebuilder-root .lb-mini.danger:hover{color:var(--red);border-color:rgba(239,114,114,.5)}
.linebuilder-root .lb-unit-status{padding:6px 8px;border-left:1px solid rgba(67,206,230,.18);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;background:rgba(0,0,0,.1)}.linebuilder-root .lb-unit-chem{color:var(--cyan);font-size:22px;line-height:1;font-weight:950;font-variant-numeric:tabular-nums}.linebuilder-root .lb-unit-chem-unit{margin-left:1px;font-size:11px;font-weight:850;opacity:.75}.linebuilder-root .lb-unit-tools{display:flex;align-items:center;justify-content:center;gap:4px;min-height:24px}.linebuilder-root .lb-warning,.linebuilder-root .lb-menu-btn{min-width:26px;height:24px;padding:0 6px;border:1px solid var(--line);border-radius:6px;color:var(--muted);background:transparent;cursor:pointer;font-size:10px;font-weight:900}.linebuilder-root .lb-warning.has{color:var(--gold);border-color:rgba(228,189,98,.55);background:rgba(228,189,98,.08)}.linebuilder-root .lb-warning-count{font-size:12px;font-weight:950;font-variant-numeric:tabular-nums}.linebuilder-root .lb-unit-menu{position:absolute;top:36px;right:6px;z-index:30;width:158px;padding:5px;border:1px solid var(--line2);border-radius:8px;background:#081a29;box-shadow:0 14px 34px rgba(0,0,0,.38);display:grid;gap:3px}.linebuilder-root .lb-menu-action{min-height:30px;padding:0 8px;border:0;border-radius:6px;color:var(--text);background:transparent;cursor:pointer;text-align:left;font-size:10px;font-weight:750}.linebuilder-root .lb-menu-action:hover:not(:disabled){background:rgba(75,217,238,.1);color:var(--cyan)}.linebuilder-root .lb-menu-action:disabled{opacity:.35}
.linebuilder-root .lb-overview{height:100%;padding:7px;display:grid;grid-template-rows:repeat(8,minmax(0,1fr));gap:5px;overflow:hidden}.linebuilder-root .lb-overview-row{min-width:0;padding:4px 6px;border:1px solid rgba(67,206,230,.18);border-radius:8px;color:var(--text);background:rgba(255,255,255,.014);cursor:pointer;display:grid;grid-template-columns:68px minmax(0,1fr) 72px;gap:7px;align-items:center}.linebuilder-root .lb-overview-row:hover{border-color:var(--line2);background:rgba(75,217,238,.1)}.linebuilder-root .lb-overview-name{color:var(--muted);font-size:9px;font-weight:900;text-transform:uppercase}.linebuilder-root .lb-overview-players{min-width:0;display:flex;gap:5px;overflow:hidden}.linebuilder-root .lb-overview-player{min-width:0;flex:1;display:flex;align-items:center;gap:4px}.linebuilder-root .lb-overview-player .player-headshot{width:26px!important;height:26px!important;flex:0 0 26px}.linebuilder-root .lb-overview-player span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:9px;font-weight:750}.linebuilder-root .lb-overview-metrics{text-align:right}.linebuilder-root .lb-overview-score{display:block;color:var(--cyan);font-size:12px;font-weight:950}.linebuilder-root .lb-overview-warning{color:var(--gold);font-size:8px}
.linebuilder-root .lb-inspector{min-height:0;display:grid;grid-template-rows:38px minmax(0,1fr);overflow:hidden}.linebuilder-root .lb-tabs{padding:4px 6px 0;border-bottom:1px solid var(--line);display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:2px}.linebuilder-root .lb-tab{border:0;border-bottom:3px solid transparent;border-radius:0;color:var(--muted);background:transparent;cursor:pointer;font-size:9px;font-weight:850;text-transform:capitalize;min-height:30px}.linebuilder-root .lb-tab.active{color:var(--text);border-bottom-color:var(--cyan);background:transparent}.linebuilder-root .lb-inspector-body{min-height:0;padding:12px;overflow:auto;display:flex;flex-direction:column;gap:10px;justify-content:flex-start;scrollbar-width:thin;scrollbar-color:rgba(67,206,230,.45) rgba(3,14,24,.72)}.linebuilder-root .lb-inspector-body::-webkit-scrollbar{width:8px}.linebuilder-root .lb-inspector-body::-webkit-scrollbar-track{background:rgba(3,14,24,.72);border:1px solid rgba(67,206,230,.18);border-radius:8px}.linebuilder-root .lb-inspector-body::-webkit-scrollbar-thumb{background:linear-gradient(180deg,rgba(75,217,238,.55),rgba(67,206,230,.28));border:1px solid rgba(67,206,230,.35);border-radius:8px}.linebuilder-root .lb-inspector-title{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:900}.linebuilder-root .lb-inspector-sub{margin-top:3px;color:var(--muted);font-size:9px}.linebuilder-root .lb-inspector-player{padding:10px;border:1px solid var(--line);border-radius:8px;background:rgba(255,255,255,.018);display:grid;grid-template-columns:62px minmax(0,1fr);gap:10px;align-items:center}.linebuilder-root .lb-inspector-player .player-headshot{width:58px!important;height:58px!important}.linebuilder-root .lb-inspector-player-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:900}.linebuilder-root .lb-inspector-player-meta{margin-top:4px;color:var(--muted2);font-size:9px;font-weight:600}.linebuilder-root .lb-gauge{padding:10px;border:1px solid var(--line);border-radius:8px;background:rgba(255,255,255,.014);display:grid;grid-template-columns:64px minmax(0,1fr);gap:10px;align-items:center}.linebuilder-root .lb-gauge-score{color:var(--cyan);font-size:30px;line-height:1;font-weight:950}.linebuilder-root .lb-gauge-label{font-size:12px;font-weight:850}.linebuilder-root .lb-gauge-source{margin-top:3px;color:var(--muted2);font-size:8px}.linebuilder-root .lb-list{min-height:0;display:grid;align-content:start;gap:8px;overflow:visible}.linebuilder-root .lb-row{min-width:0;min-height:38px;padding:8px 10px;border:1px solid rgba(67,206,230,.15);border-radius:7px;background:rgba(255,255,255,.012);display:flex;align-items:center;justify-content:space-between;gap:10px}.linebuilder-root .lb-row-label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:9px;font-weight:700}.linebuilder-root .lb-row-value{max-width:58%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:850}.linebuilder-root .lb-row-value.ok{color:var(--green)}.linebuilder-root .lb-row-value.warn{color:var(--gold)}.linebuilder-root .lb-progress{width:84px;height:5px;border:0;border-radius:5px;overflow:hidden;appearance:none}.linebuilder-root .lb-progress::-webkit-progress-bar{background:rgba(255,255,255,.06)}.linebuilder-root .lb-progress::-webkit-progress-value{background:var(--cyan)}.linebuilder-root .lb-progress::-moz-progress-bar{background:var(--cyan)}.linebuilder-root .lb-warning-row{justify-content:flex-start;color:#efc986;font-size:9px}.linebuilder-root .lb-inspector-actions{margin-top:4px;display:grid;grid-template-columns:1fr 1fr;gap:6px}.linebuilder-root .lb-compare{min-height:46px}.linebuilder-root .lb-compare-copy{min-width:0}.linebuilder-root .lb-compare-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:900}.linebuilder-root .lb-compare-meta{margin-top:3px;color:var(--muted);font-size:8px}
.linebuilder-root .lb-empty,.linebuilder-root .lb-loading{height:100%;display:grid;place-items:center;padding:18px;color:var(--muted);text-align:center;font-size:11px;font-weight:800}.linebuilder-root .lb-skeleton{width:min(220px,80%);height:10px;border-radius:5px;background:linear-gradient(90deg,rgba(255,255,255,.03),rgba(75,217,238,.12),rgba(255,255,255,.03));background-size:200% 100%;animation:lb-shimmer 1.2s linear infinite}@keyframes lb-shimmer{from{background-position:100% 0}to{background-position:-100% 0}}
.linebuilder-root .lb-popover{position:absolute;top:56px;right:86px;z-index:50;width:310px;max-height:min(440px,calc(100dvh - 90px));padding:8px;border:1px solid var(--line2);border-radius:9px;background:#081a29;box-shadow:0 18px 42px rgba(0,0,0,.45);display:grid;gap:7px;overflow:hidden}.linebuilder-root .lb-popover-title{margin:0;font-size:12px;font-weight:900}.linebuilder-root .lb-auto-options{display:grid;grid-template-columns:1fr 1fr;gap:5px}.linebuilder-root .lb-auto-option{min-height:34px;padding:0 7px;border:1px solid var(--line);border-radius:7px;color:var(--muted);background:rgba(255,255,255,.016);cursor:pointer;font-size:9px;font-weight:800}.linebuilder-root .lb-auto-option.active{color:var(--cyan);border-color:var(--line2);background:rgba(75,217,238,.1)}.linebuilder-root .lb-preview{max-height:210px;display:grid;align-content:start;gap:4px;overflow-y:auto}.linebuilder-root .lb-preview-row{padding:5px 6px;border:1px solid rgba(67,206,230,.14);border-radius:6px;display:grid;gap:2px}.linebuilder-root .lb-preview-label{color:var(--muted);font-size:8px;font-weight:800}.linebuilder-root .lb-preview-change{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:9px}.linebuilder-root .lb-popover-actions{display:grid;grid-template-columns:1fr 1fr;gap:5px}
.linebuilder-root .lb-toast{position:fixed;right:18px;bottom:18px;z-index:100;min-width:230px;max-width:340px;min-height:46px;padding:8px 10px;border:1px solid var(--line2);border-radius:9px;background:#081a29;box-shadow:0 16px 40px rgba(0,0,0,.42);display:grid;grid-template-columns:1fr auto;gap:8px;align-items:center}.linebuilder-root .lb-toast.success{border-color:rgba(84,212,155,.5)}.linebuilder-root .lb-toast.warning{border-color:rgba(228,189,98,.5)}.linebuilder-root .lb-toast.error{border-color:rgba(239,114,114,.55)}.linebuilder-root .lb-toast-message{font-size:10px;font-weight:800}.linebuilder-root .lb-toast-actions{display:flex;gap:4px}.linebuilder-root .lb-drawer-close{display:none}.linebuilder-root .lb-live{position:fixed;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}
@media(max-width:1280px){.linebuilder-root .lb-workspace{grid-template-columns:238px minmax(0,1fr) 278px}.linebuilder-root .lb-unit,.linebuilder-root .lb-col-headers{grid-template-columns:48px minmax(0,1fr) 64px}}
@media(max-width:1080px){.linebuilder-root{grid-template-columns:1fr;grid-template-rows:58px minmax(0,1fr)}.linebuilder-root .lb-sidebar{height:58px;padding:6px 8px;border-right:0;border-bottom:1px solid var(--line);flex-direction:row;align-items:center}.linebuilder-root .lb-team-mark{width:52px;height:44px;flex:0 0 52px}.linebuilder-root .lb-nav{flex:1;display:flex;grid-template-rows:none;gap:5px}.linebuilder-root .lb-nav-btn{min-width:58px;min-height:44px;width:auto;height:auto;padding:3px 8px;display:flex}.linebuilder-root .lb-shell{padding:8px;grid-template-rows:58px 36px minmax(0,1fr);gap:7px}.linebuilder-root .lb-header{height:58px}.linebuilder-root .lb-workspace{grid-template-columns:230px minmax(0,1fr)}.linebuilder-root .lb-inspector-region{position:fixed;top:66px;right:8px;bottom:8px;width:300px;height:auto;z-index:70;transform:translateX(calc(100% + 18px));transition:transform .18s;box-shadow:0 18px 46px rgba(0,0,0,.52)}.linebuilder-root .lb-inspector-region.open{transform:translateX(0)}.linebuilder-root .lb-drawer-close{display:inline-grid}.linebuilder-root .lb-mobile-tools{display:flex}}
@media(max-width:900px){.linebuilder-root .lb-workspace{grid-template-columns:1fr}.linebuilder-root .lb-pool-region{position:fixed;top:66px;left:8px;bottom:8px;width:270px;height:auto;z-index:72;transform:translateX(calc(-100% - 18px));transition:transform .18s;box-shadow:0 18px 46px rgba(0,0,0,.52)}.linebuilder-root .lb-pool-region.open{transform:translateX(0)}.linebuilder-root .lb-roster-count{display:none}}
@media(max-width:680px){.linebuilder-root .lb-team-mark{display:none}.linebuilder-root .lb-nav-btn{min-width:0;flex:1;padding:3px 4px}.linebuilder-root .lb-nav-label{display:none}.linebuilder-root .lb-title{font-size:19px}.linebuilder-root .lb-logo{width:36px;height:36px;flex-basis:36px}.linebuilder-root .lb-actions{gap:3px}.linebuilder-root .lb-actions .lb-btn{min-height:34px;padding:0 7px;font-size:9px}.linebuilder-root .lb-actions .lb-icon{width:34px;min-height:34px}.linebuilder-root .lb-pill{padding:0 6px}.linebuilder-root .lb-pill-label{display:none}.linebuilder-root .lb-mode{padding:0 8px;font-size:9px}.linebuilder-root .lb-unit,.linebuilder-root .lb-col-headers{grid-template-columns:40px minmax(0,1fr) 52px}.linebuilder-root .lb-unit-name{font-size:14px}.linebuilder-root .lb-slot{grid-template-columns:24px minmax(0,1fr);gap:4px;padding:4px}.linebuilder-root .lb-slot-pos{width:24px;height:24px}.linebuilder-root .lb-slot .player-headshot,.linebuilder-root .lb-slot-ovr,.linebuilder-root .lb-markers{display:none}.linebuilder-root .lb-slot-name{font-size:12px}.linebuilder-root .lb-slot-meta{font-size:8px}.linebuilder-root .lb-unit-chem{font-size:14px}.linebuilder-root .lb-col-headers-chem{display:none}}
`}</style>;
}
...
function CompactPlayerSlot({ descriptor, player, locked, selected, targetState, onSelect, onDrop, onDragStart, onRemove, onToggleLock, onKeyDown, registerRef }) {
  ...
  return <div ref={(node) => registerRef(descriptor.key, node)} className={classes} role="button" tabIndex={0} aria-label={player ? `${descriptor.slot}, ${player.name}, ${player.overall} overall` : `${descriptor.slot}, empty`} title={player ? shortText(getOverallTooltip(player)) : `Add ${descriptor.slot}`} onClick={() => onSelect(descriptor)} onKeyDown={(event) => onKeyDown(event, descriptor)} onDragOver={(event) => { event.preventDefault(); event.dataTransfer.dropEffect = "move"; }} onDrop={(event) => onDrop(event, descriptor)}>
    {player ? <>
      <div className="lb-slot-shot" draggable={!locked && player.availability?.placeable} onDragStart={(event) => { event.stopPropagation(); onDragStart(event, player.id); }}><PlayerHeadshot player={player} size="sm" /></div>
