...
const NAV_ALIAS_TO_SCREEN = {
  [SCREEN_KEYS.office]: SCREENS.HUB,
  ...
  [SCREEN_KEYS.finances]: SCREENS.CAP_LEDGER,
  [SCREEN_KEYS.inbox]: SCREENS.STORYLINES,
  [SCREEN_KEYS.standings]: SCREENS.STATS,
  [SCREEN_KEYS.league]: SCREENS.STATS,
  [SCREEN_KEYS.prospects]: SCREENS.DRAFT_CLASS,
  [SCREEN_KEYS.settings]: SCREENS.SETTINGS,
  [SCREEN_KEYS.injury_report]: SCREENS.ROSTER,
